...
class Forecastting:
    def forecast(self, file_path, raw_range):
        ...
        print(is_increase, proba_positive, forecast_res.iloc[0] * abs(proba_positive - 0.5))
        return is_increase, proba_positive, forecast_res.iloc[0] * abs(proba_positive - 0.5)
