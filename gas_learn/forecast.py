...
class Forecastting:
    def forecast(self, file_path, raw_range):
        ...
        print(is_increase, proba_positive, forecast_m - range_forecast.iloc[len(range_forecast) - 120 : len(range_forecast) , 3].sum(), -range_forecast.iloc[len(range_forecast) - 120 : len(range_forecast) , 3].sum())
        return is_increase, proba_positive,  forecast_m - range_forecast.iloc[len(range_forecast) - 120 : len(range_forecast) , 3].sum()
